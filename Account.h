...
public:
    ...
    const string &getCardId() const {return cardId;}
    ...
    double getQuotaMoney() const {return quotaMoney;}

    void setCardId(const string &cardId) {this->cardId = cardId;}
    ...
    void setQuotaMoney(double quotaMoney) {this->quotaMoney = quotaMoney;}
};
